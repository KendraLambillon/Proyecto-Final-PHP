...
#Definimos una funccion para realizar la conexion a la base de datos
...
#Esta variable aunque sea la misma que la variable en el return de la linea 34, hay que tener en cuenta que son elementos diferentes
#Pero siempre se suele mantener el mismo nombre de la variable return, porque es un resultado que le vamos a asociar a la variable
